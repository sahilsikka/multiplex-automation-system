...
<%
MovieBean mBean=(MovieBean)request.getAttribute("movie");
...
<tr><td>Movie id:</td><td> <input type="text" name="mid" value="<%= mBean.getMovieId()%>" class="form-control"readonly></td></tr>
<tr><td>Movie name:</td><td> <input type="text" name="mname" value="<%=mBean.getMovieName()%>" class="form-control"readonly></td></tr>
<tr><td>Movie language: </td><td><input type="text" name="language" value="<%=mBean.getLanguage()%>" class="form-control"readonly></td></tr>
<tr><td>Category:</td><td> <input type="text" name="category" value="<%=mBean.getCategory()%>" class="form-control" readonly></td></tr>
<tr><td>Start date:</td><td> <input type="text" name="sdate" value="<%=mBean.getStartDate()%>" class="form-control" readonly></td></tr>
<tr><td>End date:</td><td> <input type="text" name="edate" value="<%=mBean.getEndDate()%>" class="form-control"readonly></td></tr>
<tr><td>Status:</td><td> <input type="text" name="status" value="<%=mBean.getStatus()%>" class="form-control"readonly></td></tr>
