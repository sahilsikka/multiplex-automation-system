...
<table class="table table-condensed">
      <tr>
      <td>
      <p><a href="<%=request.getContextPath()%>/movieController?source=addmovie"><b>Add Movie</b></a></p><br><br>
      </td>
      <td>
      <p><a href="<%=request.getContextPath()%>/ShowController?source=addshowpage"><b>Add Show</b></a></p><br><br>
      </td></tr>      
      
      <tr>
      <td>
      	<p><a href="<%=request.getContextPath()%>/movieController?source=viewallmovie"><b>View All Movie</b></a></p><br><br>
      </td>
       <td><p><a href="<%=request.getContextPath()%>/CustomerContrller?source=viewallcustomer"><b>View All Customer</b></a></p><br><br>
       </td>
      </tr>
      <tr>
      <td> <p><a href="<%=request.getContextPath()%>/movieController?source=updatemovie"><b>Update Movie</b></a></p><br><br>
      </td>
      <td>
      <p><a href="<%=request.getContextPath()%>/ShowController?source=viewallshow"><b>View All show</b></a></p>
      </td></tr>
      
       <tr>
      <td>
    <p>  <a href="<%=request.getContextPath()%>/movieController?source=viewmoviebyfield"><b>View Movie By Field</b></a></p>
      </td>
      <td>
      <p>  <a href="<%=request.getContextPath()%>/TicketController?source=viewbooking"><b>View Bookings</b></a></p>
      </td>
      </tr>
      </table>
